 ...
 */
public class SendRegistrationData {
   ...
   private Utils utils;
    ...
    public SendRegistrationData(final Activity activity, final Map<String, String> map, final ServerCallback callback)
    {
        ...
        pDialog.show();
        sr = new StringRequest(Request.Method.POST, BaseUrl.BASE_URL+BaseUrl.registration , new Response.Listener<String>()
        {
            @Override
