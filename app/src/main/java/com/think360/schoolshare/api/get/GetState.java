...
public class GetState
{
    ...
    public GetState(final Context context, String country_id, final ServerCallBackArray callback)
    {
        ...
        sr = new StringRequest(Request.Method.GET, BaseUrl.BASE_URL+BaseUrl.get_state+BaseUrl.country_id+country_id, new Response.Listener<String>()
        {
            @Override
