...
public class GetChapters
{
    ...
    public GetChapters(final Context context, final ServerCallBackArray callback)
    {
        ...
        sr = new StringRequest(Request.Method.GET, BaseUrl.BASE_URL+BaseUrl.get_chapter, new Response.Listener<String>()
        {
            @Override
