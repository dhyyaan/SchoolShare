...
public class GetCountry
{
    ...
    public GetCountry(final Context context, final ServerCallBackArray callback)
    {
        ...
        sr = new StringRequest(Request.Method.GET, BaseUrl.BASE_URL+BaseUrl.get_country, new Response.Listener<String>()
        {
            @Override
