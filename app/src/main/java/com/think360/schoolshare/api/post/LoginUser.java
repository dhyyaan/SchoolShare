package com.think360.schoolshare.activity.api.api.post;
...
/**
 * Created by think360user on 30/12/16.
 */
public class LoginUser {
    ...
    public LoginUser(final Activity activity, final String username,final String password, final ServerCallback callback)
    {
