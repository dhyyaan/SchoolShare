...
import com.think360.schoolshare.databinding.LayoutProfessionalInfoBinding;
 ...
 * Use the {@link ProfessionalInfoEditFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProfessionalInfoEditFragment extends RootFragment implements View.OnClickListener{
    ...
    public ProfessionalInfoEditFragment() {
    ...
    public static ProfessionalInfoEditFragment newInstance(JSONObject obj, String param2) {
        ProfessionalInfoEditFragment fragment = new ProfessionalInfoEditFragment();
        objS = obj;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LayoutProfessionalInfoBinding binding = DataBindingUtil.inflate(inflater, R.layout.layout_professional_info, container, false);
        ProfileModel profile = new ProfileModel(mOrganisationName, mIndustry, mDesignation, mLinkdin, mResumeId,
                mResume , mADDITIONAL_INFOP);
    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.edit:
                ...
                transaction.replace(R.id.fragContainer, ProfessionalInfoEditFragmentSubmit.newInstance(objS, "")).commitAllowingStateLoss();
                // MainFragment.callBack(13);
                break;
        }
    }
